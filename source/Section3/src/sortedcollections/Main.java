...
//        System.out.println(stockList);
        ...
        // Throws an exception since items cannot be added to the unmodifiable map.
//        temp = new StockItem("pen", 1.12);
//        stockList.Items().put(temp.getName(), temp);

        // This works as changes are being made to the individual object rather than the map.
