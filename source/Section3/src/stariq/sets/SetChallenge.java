...
the solarSystem collection and in the stariq.sets of moons for the appropriate planets.
...
6. Two bodies with the same name but different designations can be added to the same stariq.map,
and can be retrieved from the stariq.map.
*/
