...
public class Main {
    ...
    public static void startAdventure(){
        ...
        while(true){
            ...
            // This is because the locations stariq.map takes in integer and location object as argument when using the put() method.
            System.out.println(locations.get(loc).getDescription());
            if(loc == 0){
                break;
            }

            // getExits() method retrieves the stariq.map of valid exits from the current location.
